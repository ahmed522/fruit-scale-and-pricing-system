 ...
 * Converted from Arduino C++ library to pure C
 * Original: https://github.com/bogde/HX711
 * MIT License - (c) 2018 Bogdan Necula
 * Converted by: Ahmed Abdelaal - 2025
 *
 ******************************************************************************/
